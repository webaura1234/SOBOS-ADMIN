...
export function GlobalSearch() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center pt-[12vh] bg-[var(--scrim)]" onClick={() => setGlobalSearchOpen(false)}>
        ...
        <Command label="Global search" shouldFilter={false}>
          ...
          <Command.List className="max-h-[min(420px,60vh)] overflow-auto p-2 scrollbar-thin">
            {query.trim().length >= 2 && results.length === 0 && !loading && (
              <Command.Empty className="py-8 text-center text-sm text-text-muted font-medium">No records found for “{query}”.</Command.Empty>
            )}
              ...
              <Command.Group key={group} heading={group} className="[&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-bold [&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-wide [&_[cmdk-group-heading]]:text-text-muted [&_[cmdk-group-heading]]:px-3 [&_[cmdk-group-heading]]:py-2">
                {items.map((item) => (
                  <Command.Item
                    ...
                    className="flex flex-col gap-0.5 px-3 py-3 rounded-xl text-sm cursor-pointer aria-selected:bg-surface-2 hover:bg-surface-2 transition-colors"
                  >
            ...
            {query.trim().length < 2 && (
              <>
                <Command.Group heading="Quick actions" className="[&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-bold [&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-wide [&_[cmdk-group-heading]]:text-text-muted [&_[cmdk-group-heading]]:px-3 [&_[cmdk-group-heading]]:py-2">
                  {QUICK_ACTIONS.map((a) => (
                    <Command.Item
                      key={a.href}
                      value={a.label}
                ...
                <Command.Group heading="Pages" className="[&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-bold [&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-wide [&_[cmdk-group-heading]]:text-text-muted [&_[cmdk-group-heading]]:px-3 [&_[cmdk-group-heading]]:py-2">
                  {NAV_ITEMS.map((item) => (
                    <Command.Item
                      key={item.href}
                      value={item.label}
